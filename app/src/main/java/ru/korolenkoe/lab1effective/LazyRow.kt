...
internal val listHeroes = listOf(
    HeroItem(R.string.deadpool,R.string.deadpool, R.drawable.dedpool,
        "https://www.tailorbrands.com/wp-content/uploads/2020/03/Deadpool-.jpg"),
    HeroItem(R.string.captain_america,R.string.captain_america, R.drawable.capitan,
        "https://www.tailorbrands.com/wp-content/uploads/2020/03/Captain-America.jpg"),
    HeroItem(R.string.doctor_strange, R.string.deadpool,R.drawable.doctor,
